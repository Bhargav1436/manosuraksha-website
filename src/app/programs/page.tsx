    ...
    <PageTransition>
      ...
      >
        ...
        <div className="relative mx-auto" style={{ maxWidth: 1280 }}>
          ...
          {/* Program cards with alternating accent colors */}
          {(() => {
            const cardAccents = [
                      ...
                      >
                        ...
                        >
                            ...
                            <div className="absolute bottom-4 left-4">
                              <span
                                className={cn(
                                  ...
                                  "text-[11px] font-[700] uppercase tracking-wider",
                                  "transition-all duration-400"
                                )}
                          ...
                          <div className="p-6 pb-7 flex flex-col flex-1">
                            ...
                            <h3
                              className={cn(
                                "font-['Nunito_Sans',sans-serif] mb-3",
      ...
      >
        <div className="mx-auto text-center" style={{ maxWidth: 1280 }}>
          <MotionWrapper variant="fadeInUp">
            ...
            >
              Contact us for guidance. Our team will help you find the best path to
              mental wellness.
            </p>
            <Link
              href="/contact"
